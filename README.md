...
- Tips for this part: 
    ...
    - Password: It is just the password for the above username, but if you forgot run 
        - ALTER USER <theUsernameFromAbove> WITH PASSWORD 'bored';
...
3. Inside the backend folder, run python3 gateway.py will power up the API
4. http://127.0.0.1:5000/api/data is the localhost endpoint to return the results of the sample query in JSON. Use the other endpoints to try out the other sample queries.
5. Frontend... Soon